        ...
        return html.Div([
            dbc.Row([
                dbc.Col([
                    ...
                    dbc.Input(id="fct28-input", type="number", value=2.5, min=1, max=100, step=0.1),
                ], md=4),
                dbc.Col([
                    dbc.Label("a (보통 1.0)"),
                    dbc.Input(id="a-input", type="number", value=1.0, min=0.5, max=2, step=0.01),
                ], md=2),
                dbc.Col([
                    dbc.Label("b (보통 1.0)"),
                    dbc.Input(id="b-input", type="number", value=1.0, min=0.5, max=2, step=0.01),
                ], md=2),
            ], className="g-2"),
    ...
    if formula_type == "ceb":
        ...
        return html.Div([
            dbc.Row([
                dbc.Col([
                    dbc.Label("fct,28 (28일 인장강도, GPa)"),
                    dbc.Input(id="fct28-input", type="number", value=fct28 or 2.5, min=1, max=100, step=0.1),
                ], md=4),
                dbc.Col([
                    dbc.Label("a (보통 1.0)"),
                    dbc.Input(id="a-input", type="number", value=a or 1.0, min=0.5, max=2, step=0.01),
                ], md=2),
                dbc.Col([
                    dbc.Label("b (보통 1.0)"),
                    dbc.Input(id="b-input", type="number", value=b or 1.0, min=0.5, max=2, step=0.01),
                ], md=2),
            ], className="g-2"),
            html.Small("식: fct(t) = fct,28 * ( t / (a + b*t) )^0.5", style={"color": "#64748b"}),

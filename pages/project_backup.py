    ...
    children=[
        ...
        dbc.Row([
            dbc.Col([
                ...
                html.Div([
                    html.Div([
                        html.H6("📝 프로젝트 정보", style={
                            "fontWeight": "600",
                            "color": "#374151",
                            "marginBottom": "12px",
                            "fontSize": "14px"
                        }),
                        html.Div(id="project-info", style={
                            "padding": "16px",
                            "backgroundColor": "#f9fafb",
                            "borderRadius": "8px",
                            "border": "1px solid #e5e7eb",
            ...
            dbc.Col([
                ...
                dash_table.DataTable(
                    ...
                    columns=[
                        ...
                        {"name": "분석 시작일", "id": "start_date"},
                        {"name": "분석 종료일", "id": "end_date"},
                        {"name": "분석 시간", "id": "analysis_time"},
                        {"name": "분석 진행률", "id": "analysis_progress"},
                        {"name": "분석 상태", "id": "analysis_status"},
                        {"name": "분석 결과", "id": "analysis_result"},
                        {"name": "분석 결과 상세", "id": "analysis_result_detail"},
                        {"name": "분석 결과 상세 2", "id": "analysis_result_detail_2"},
                        {"name": "분석 결과 상세 3", "id": "analysis_result_detail_3"},
                        {"name": "분석 결과 상세 4", "id": "analysis_result_detail_4"},
                        {"name": "분석 결과 상세 5", "id": "analysis_result_detail_5"},
                        {"name": "분석 결과 상세 6", "id": "analysis_result_detail_6"},
                        {"name": "분석 결과 상세 7", "id": "analysis_result_detail_7"},
                        {"name": "분석 결과 상세 8", "id": "analysis_result_detail_8"},
                        {"name": "분석 결과 상세 9", "id": "analysis_result_detail_9"},
                        {"name": "분석 결과 상세 10", "id": "analysis_result_detail_10"},
                        {"name": "분석 결과 상세 11", "id": "analysis_result_detail_11"},
                        {"name": "분석 결과 상세 12", "id": "analysis_result_detail_12"},
                        {"name": "분석 결과 상세 13", "id": "analysis_result_detail_13"},
                        {"name": "분석 결과 상세 14", "id": "analysis_result_detail_14"},
                        {"name": "분석 결과 상세 15", "id": "analysis_result_detail_15"},
                        {"name": "분석 결과 상세 16", "id": "analysis_result_detail_16"},
                        {"name": "분석 결과 상세 17", "id": "analysis_result_detail_17"},
                        {"name": "분석 결과 상세 18", "id": "analysis_result_detail_18"},
                        {"name": "분석 결과 상세 19", "id": "analysis_result_detail_19"},
                        {"name": "분석 결과 상세 20", "id": "analysis_result_detail_20"},
                        {"name": "분석 결과 상세 21", "id": "analysis_result_detail_21"},
                        {"name": "분석 결과 상세 22", "id": "analysis_result_detail_22"},
                        {"name": "분석 결과 상세 23", "id": "analysis_result_detail_23"},
                        {"name": "분석 결과 상세 24", "id": "analysis_result_detail_24"},
                        {"name": "분석 결과 상세 25", "id": "analysis_result_detail_25"},
                        {"name": "분석 결과 상세 26", "id": "analysis_result_detail_26"},
                        {"name": "분석 결과 상세 27", "id": "analysis_result_detail_27"},
                        {"name": "분석 결과 상세 28", "id": "analysis_result_detail_28"},
                        {"name": "분석 결과 상세 29", "id": "analysis_result_detail_29"},
                        {"name": "분석 결과 상세 30", "id": "analysis_result_detail_30"},
                        {"name": "분석 결과 상세 31", "id": "analysis_result_detail_31"},
                        {"name": "분석 결과 상세 32", "id": "analysis_result_detail_32"},
                        {"name": "분석 결과 상세 33", "id": "analysis_result_detail_33"},
                        {"name": "분석 결과 상세 34", "id": "analysis_result_detail_34"},
                        {"name": "분석 결과 상세 35", "id": "analysis_result_detail_35"},
                        {"name": "분석 결과 상세 36", "id": "analysis_result_detail_36"},
                        {"name": "분석 결과 상세 37", "id": "analysis_result_detail_37"},
                        {"name": "분석 결과 상세 38", "id": "analysis_result_detail_38"},
                        {"name": "분석 결과 상세 39", "id": "analysis_result_detail_39"},
                        {"name": "분석 결과 상세 40", "id": "analysis_result_detail_40"},
                        {"name": "분석 결과 상세 41", "id": "analysis_result_detail_41"},
                        {"name": "분석 결과 상세 42", "id": "analysis_result_detail_42"},
                        {"name": "분석 결과 상세 43", "id": "analysis_result_detail_43"},
                        {"name": "분석 결과 상세 44", "id": "analysis_result_detail_44"},
                        {"name": "분석 결과 상세 45", "id": "analysis_result_detail_45"},
                        {"name": "분석 결과 상세 46", "id": "analysis_result_detail_46"},
                        {"name": "분석 결과 상세 47", "id": "analysis_result_detail_47"},
                        {"name": "분석 결과 상세 48", "id": "analysis_result_detail_48"},
                        {"name": "분석 결과 상세 49", "id": "analysis_result_detail_49"},
                        {"name": "분석 결과 상세 50", "id": "analysis_result_detail_50"},
                        {"name": "분석 결과 상세 51", "id": "analysis_result_detail_51"},
                        {"name": "분석 결과 상세 52", "id": "analysis_result_detail_52"},
                        {"name": "분석 결과 상세 53", "id": "analysis_result_detail_53"},
                        {"name": "분석 결과 상세 54", "id": "analysis_result_detail_54"},
                        {"name": "분석 결과 상세 55", "id": "analysis_result_detail_55"},
                        {"name": "분석 결과 상세 56", "id": "analysis_result_detail_56"},
                        {"name": "분석 결과 상세 57", "id": "analysis_result_detail_57"},
                        {"name": "분석 결과 상세 58", "id": "analysis_result_detail_58"},
                        {"name": "분석 결과 상세 59", "id": "analysis_result_detail_59"},
                        {"name": "분석 결과 상세 60", "id": "analysis_result_detail_60"},
                        {"name": "분석 결과 상세 61", "id": "analysis_result_detail_61"},
                        {"name": "분석 결과 상세 62", "id": "analysis_result_detail_62"},
                        {"name": "분석 결과 상세 63", "id": "analysis_result_detail_63"},
                        {"name": "분석 결과 상세 64", "id": "analysis_result_detail_64"},
                        {"name": "분석 결과 상세 65", "id": "analysis_result_detail_65"},
                        {"name": "분석 결과 상세 66", "id": "analysis_result_detail_66"},
                        {"name": "분석 결과 상세 67", "id": "analysis_result_detail_67"},
                        {"name": "분석 결과 상세 68", "id": "analysis_result_detail_68"},
                        {"name": "분석 결과 상세 69", "id": "analysis_result_detail_69"},
                        {"name": "분석 결과 상세 70", "id": "analysis_result_detail_70"},
                        {"name": "분석 결과 상세 71", "id": "analysis_result_detail_71"},
                        {"name": "분석 결과 상세 72", "id": "analysis_result_detail_72"},
                        {"name": "분석 결과 상세 73", "id": "analysis_result_detail_73"},
                        {"name": "분석 결과 상세 74", "id": "analysis_result_detail_74"},
                        {"name": "분석 결과 상세 75", "id": "analysis_result_detail_75"},
                        {"name": "분석 결과 상세 76", "id": "analysis_result_detail_76"},
                        {"name": "분석 결과 상세 77", "id": "analysis_result_detail_77"},
                        {"name": "분석 결과 상세 78", "id": "analysis_result_detail_78"},
                        {"name": "분석 결과 상세 79", "id": "analysis_result_detail_79"},
                        {"name": "분석 결과 상세 80", "id": "analysis_result_detail_80"},
                        {"name": "분석 결과 상세 81", "id": "analysis_result_detail_81"},
                        {"name": "분석 결과 상세 82", "id": "analysis_result_detail_82"},
                        {"name": "분석 결과 상세 83", "id": "analysis_result_detail_83"},
                        {"name": "분석 결과 상세 84", "id": "analysis_result_detail_84"},
                        {"name": "분석 결과 상세 85", "id": "analysis_result_detail_85"},
                        {"name": "분석 결과 상세 86", "id": "analysis_result_detail_86"},
                        {"name": "분석 결과 상세 87", "id": "analysis_result_detail_87"},
                        {"name": "분석 결과 상세 88", "id": "analysis_result_detail_88"},
                        {"name": "분석 결과 상세 89", "id": "analysis_result_detail_89"},
                        {"name": "분석 결과 상세 90", "id": "analysis_result_detail_90"},
                        {"name": "분석 결과 상세 91", "id": "analysis_result_detail_91"},
                        {"name": "분석 결과 상세 92", "id": "analysis_result_detail_92"},
                        {"name": "분석 결과 상세 93", "id": "analysis_result_detail_93"},
                        {"name": "분석 결과 상세 94", "id": "analysis_result_detail_94"},
                        {"name": "분석 결과 상세 95", "id": "analysis_result_detail_95"},
                        {"name": "분석 결과 상세 96", "id": "analysis_result_detail_96"},
                        {"name": "분석 결과 상세 97", "id": "analysis_result_detail_97"},
                        {"name": "분석 결과 상세 98", "id": "analysis_result_detail_98"},
                        {"name": "분석 결과 상세 99", "id": "analysis_result_detail_99"},
                        {"name": "분석 결과 상세 100", "id": "analysis_result_detail_100"},
                        {"name": "분석 결과 상세 101", "id": "analysis_result_detail_101"},
                        {"name": "분석 결과 상세 102", "id": "analysis_result_detail_102"},
                        {"name": "분석 결과 상세 103", "id": "analysis_result_detail_103"},
                        {"name": "분석 결과 상세 104", "id": "analysis_result_detail_104"},
                        {"name": "분석 결과 상세 105", "id": "analysis_result_detail_105"},
                        {"name": "분석 결과 상세 106", "id": "analysis_result_detail_106"},
                        {"name": "분석 결과 상세 107", "id": "analysis_result_detail_107"},
                        {"name": "분석 결과 상세 108", "id": "analysis_result_detail_108"},
                        {"name": "분석 결과 상세 109", "id": "analysis_result_detail_109"},
                        {"name": "분석 결과 상세 110", "id": "analysis_result_detail_110"},
                        {"name": "분석 결과 상세 111", "id": "analysis_result_detail_111"},
                        {"name": "분석 결과 상세 112", "id": "analysis_result_detail_112"},
                        {"name": "분석 결과 상세 113", "id": "analysis_result_detail_113"},
                        {"name": "분석 결과 상세 114", "id": "analysis_result_detail_114"},
                        {"name": "분석 결과 상세 115", "id": "analysis_result_detail_115"},
                        {"name": "분석 결과 상세 116", "id": "analysis_result_detail_116"},
                        {"name": "분석 결과 상세 117", "id": "analysis_result_detail_117"},
                        {"name": "분석 결과 상세 118", "id": "analysis_result_detail_118"},
                        {"name": "분석 결과 상세 119", "id": "analysis_result_detail_119"},
                        {"name": "분석 결과 상세 120", "id": "analysis_result_detail_120"},
                        {"name": "분석 결과 상세 121", "id": "analysis_result_detail_121"},
                        {"name": "분석 결과 상세 122", "id": "analysis_result_detail_122"},
                        {"name": "분석 결과 상세 123", "id": "analysis_result_detail_123"},
                        {"name": "분석 결과 상세 124", "id": "analysis_result_detail_124"},
                        {"name": "분석 결과 상세 125", "id": "analysis_result_detail_125"},
                        {"name": "분석 결과 상세 126", "id": "analysis_result_detail_126"},
                        {"name": "분석 결과 상세 127", "id": "analysis_result_detail_127"},
                        {"name": "분석 결과 상세 128", "id": "analysis_result_detail_128"},
                        {"name": "분석 결과 상세 129", "id": "analysis_result_detail_129"},
                        {"name": "분석 결과 상세 130", "id": "analysis_result_detail_130"},
                        {"name": "분석 결과 상세 131", "id": "analysis_result_detail_131"},
#!/usr/bin/env python3
# pages/project.py
# 현재 파일: pages/project.py
"""Dash 페이지: 프로젝트 및 콘크리트 관리
...
layout = dbc.Container(
    ...
    children=[
        ...
        dbc.Row([
            dbc.Col([
                html.H3("🏠 홈", id="header-title", className="text-primary", style={"fontWeight": "600"}),
                html.P("콘크리트 온도 분석 시스템", className="text-muted", style={"fontSize": "14px"}),
            ], md=6),
            dbc.Col([
                html.Div([
                    dbc.Button(
                    ...
                    dbc.Button(
                        [html.I(className="fas fa-sign-out-alt me-1"), "로그아웃"],
                        id="btn-logout",
                        color="secondary",
                        size="lg",
                        style={
